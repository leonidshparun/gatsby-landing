...
const feedbackData = [
  {
    ...
    feedback:
      'We were initially skeptical of doing any development with an outside firm, but CleverSoft has been a great partner. The team at CleverSoft is very skilled and has been a pleasure to work with. Not only have they enabled us to expand our team but they have added capability as well. They have enabled us to adopt new technologies as they add their diverse skillset to our team. I would not hesitate to recommend CleverSoft to anyone looking for a great software development company.'
  },
  {
    company: {
      name: 'CityIndex'
    ...
    feedback:
      'Since our first engagement a year ago, I have been impressed not only by the quality of work that CleverSoft have done for City Index but also their attention to detail and reliability on delivery dates.'
  },
  {
    company: {
      name: 'BullionRock'
  ...
  },
  {
    ...
    feedback:
      'We were searching the world for a text summariser, and were delighted to discover the Intellexer API from CleverSoft. After discussing our requirements with their team, it was evident that their solutions would not just meet our requirements but would also do more things than we had originally envisaged. It is also of great and ongoing benefit that they continue to develop their products so that we can offer new things to our customers. I thoroughly recommend CleverSoft to others. They are a really responsive team to work with.'
  },
  {
    company: {
      name: 'Cognite'
    ...
    feedback:
      'Our long-term cooperation with CleverSoft dates back to 2008. Since then we`ve been working on a number of complex lasting projects, and practically all the time CleverSoft was able to satisfy our immediate needs in resources and to meet our high demands for project results. We haven`t finished our current projects yet, but I am already looking forward to broaden our common horizons.'
  }
];
